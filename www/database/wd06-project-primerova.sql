...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июл 30 2019 г., 20:27
...
CREATE TABLE `goods` (
  ...
  `img_small` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Кресло', 150, 200, '', '108797943600.jpg', 'preview-108797943600.jpg');
...
INSERT INTO `orders` (`id`, `name`, `lastname`, `email`, `phone`, `address`, `items`, `user_id`, `items_count`, `total_price`, `status`, `payment`, `date_time`) VALUES
(1, 'Раиса', 'Fsda', 'info@mail.com', '555-55-55', 'qwqeqweq', '[{\"id\":\"1\",\"price\":\"150\",\"count\":1,\"title\":\"Something\"}]', 6, 1, 150, 'new', 'no', '2019-07-13 02:09:57'),
(2, 'Раиса', 'asdas', 'info@mail.com', '5555555555', 'kdjdajl', '[{\"id\":\"1\",\"price\":\"150\",\"count\":3,\"title\":\"Something\"}]', 6, 3, 450, 'new', 'no', '2019-07-13 02:16:41'),
(3, 'asd', 'adas', 'mail@mail.com', '2222222222', 'sada', '[{\"id\":\"1\",\"price\":\"150\",\"count\":5,\"title\":\"Something\"}]', 16, 5, 750, 'new', 'no', '2019-07-13 05:21:53'),
(4, 'Раиса', 'sdfsd', 'info@mail.com', '5165', 'asda', '[{\"id\":\"1\",\"price\":\"150\",\"count\":1,\"title\":\"Something\"}]', 6, 1, 150, 'new', 'no', '2019-07-14 00:23:33'),
(5, 'Раиса', 'sda', 'info@mail.com', '213', 'wdas', '[{\"id\":\"1\",\"price\":\"150\",\"count\":1,\"title\":\"Something\"}]', 6, 1, 150, 'new', 'no', '2019-07-14 00:38:46');
...
CREATE TABLE `users` (
  ...
  `cart` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `email`, `password`, `role`, `name`, `lastname`, `city`, `country`, `recovery_code`, `recovery_code_times`, `avatar`, `avatar_small`, `cart`) VALUES
...
(16, 'mail@mail.com', '$2y$10$cC.SMaXz2kfCAq8N1AS/KekoXzST8FMfnLftVR12WW8i0F0ip7T7u', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '');
